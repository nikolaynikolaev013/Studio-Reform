...
export const LocationIcon = ({ color = "#323232" }: IBaseIconProps) => {
  return (
    <svg
      version="1.1"
      id="Layer_1"
    ...
    >
      ...
      <g>
        ...
        c5.57,9.17,6.77,20.87,4.32,32.73c-2.41,11.71-8.41,23.62-17.28,33.35V82.78L78.81,82.78L78.81,82.78z 
