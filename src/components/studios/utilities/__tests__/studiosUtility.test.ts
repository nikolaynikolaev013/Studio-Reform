...
describe("studioSofiaCenter", () => {
  it("should have correct studio information", () => {
    ...
    expect(studioSofiaCenter.googleMapsLink).toBe(
      "https://maps.app.goo.gl/76sjF14ttUPuk6CY6"
    );
    expect(studioSofiaCenter.lat).toBe(42.7011482);
    expect(studioSofiaCenter.lng).toBe(23.3214208);
    expect(studioSofiaCenter.link).toBe(
      "https://reservation.studio/bg/location/studio-reform-pilates/classes"
    );
  });
  ...
  it("should have correct phone numbers", () => {
    ...
    expect(studioSofiaCenter.phoneNumbers[0].phoneLink).toBe(
      "tel:00359887414101"
    );
  });
...
describe("studioVarnaLevski", () => {
  it("should have correct studio information", () => {
    ...
    expect(studioVarnaLevski.address).toBe(
      "Детски център 'Мама и аз', етаж 1, Варна"
    );
    expect(studioVarnaLevski.googleMapsLink).toBe(
      "https://maps.app.goo.gl/whkdPmhyXQ2G5u5N6"
    );
  ...
  it("should have correct phone numbers", () => {
    ...
    expect(studioVarnaLevski.phoneNumbers[1].phoneLink).toBe(
      "tel:00359889953740"
    );
  });
});
...
describe("studioVarnaCenter", () => {
  it("should have correct studio information", () => {
    ...
    expect(studioVarnaCenter.workingHours).toBe(
      "Пон-Пет; 8:00-20:00; Съб: 9:00-18:00"
    );
    expect(studioVarnaCenter.address).toBe(
  ...
  it("should have correct phone numbers", () => {
    ...
    expect(studioVarnaCenter.phoneNumbers[0].phoneLink).toBe(
      "tel:00359889953740"
    );
  });
});
...
describe("studioVarnaTroshevo", () => {
  it("should have correct studio information", () => {
    ...
    expect(studioVarnaTroshevo.workingHours).toBe(
      "Пон-Пет; 8:00-20:00; Съб: 9:00-18:00"
    );
    expect(studioVarnaTroshevo.address).toBe(
      "Варна, ул.'Младежка' 141, ет.2, Варна"
    );
    expect(studioVarnaTroshevo.googleMapsLink).toBe(
      "https://maps.app.goo.gl/9eW69VpRbY3RQScBA"
    );
  ...
  it("should have correct phone numbers", () => {
    ...
    expect(studioVarnaTroshevo.phoneNumbers[0].phoneLink).toBe(
      "tel:00359889953740"
    );
  });
});
